 ...
 */
var LnrpcListChannelsResponse = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>LnrpcListChannelsResponse</code>.
   * @alias module:model/LnrpcListChannelsResponse
   */
  function LnrpcListChannelsResponse() {
    _classCallCheck(this, LnrpcListChannelsResponse);
  ...
  _createClass(LnrpcListChannelsResponse, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('channels')) {
          obj['channels'] = _ApiClient["default"].convertToType(data['channels'], [_LnrpcChannel["default"]]);
        }
      }
  ...
  return LnrpcListChannelsResponse;
}();
/**
...
var _default = LnrpcListChannelsResponse;
