 ...
 */
var LnrpcKeyLocator = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>LnrpcKeyLocator</code>.
   * @alias module:model/LnrpcKeyLocator
   */
  function LnrpcKeyLocator() {
    _classCallCheck(this, LnrpcKeyLocator);
  ...
  _createClass(LnrpcKeyLocator, null, [{
    key: "initialize",
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('key_family')) {
          obj['key_family'] = _ApiClient["default"].convertToType(data['key_family'], 'Number');
        }

        if (data.hasOwnProperty('key_index')) {
          obj['key_index'] = _ApiClient["default"].convertToType(data['key_index'], 'Number');
        }
      }
