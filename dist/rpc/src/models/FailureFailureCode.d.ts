 ...
 * @enum {string}
 */
export declare enum FailureFailureCode {
    Reserved = "RESERVED",
...
export declare function FailureFailureCodeFromJSON(json: any): FailureFailureCode;
export declare function FailureFailureCodeFromJSONTyped(json: any, ignoreDiscriminator: boolean): FailureFailureCode;
export declare function FailureFailureCodeToJSON(value?: FailureFailureCode | null): any;
