 ...
 * @enum {string}
 */
export declare enum LnrpcPaymentFailureReason {
...
export declare function LnrpcPaymentFailureReasonFromJSON(json: any): LnrpcPaymentFailureReason;
export declare function LnrpcPaymentFailureReasonFromJSONTyped(json: any, ignoreDiscriminator: boolean): LnrpcPaymentFailureReason;
export declare function LnrpcPaymentFailureReasonToJSON(value?: LnrpcPaymentFailureReason | null): any;
