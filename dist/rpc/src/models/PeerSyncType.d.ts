...
export declare function PeerSyncTypeFromJSON(json: any): PeerSyncType;
export declare function PeerSyncTypeFromJSONTyped(json: any, ignoreDiscriminator: boolean): PeerSyncType;
export declare function PeerSyncTypeToJSON(value?: PeerSyncType | null): any;
