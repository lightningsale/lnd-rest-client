 ...
 * @enum {string}
 */
export declare enum LnrpcFeatureBit {
...
export declare function LnrpcFeatureBitFromJSON(json: any): LnrpcFeatureBit;
export declare function LnrpcFeatureBitFromJSONTyped(json: any, ignoreDiscriminator: boolean): LnrpcFeatureBit;
export declare function LnrpcFeatureBitToJSON(value?: LnrpcFeatureBit | null): any;
