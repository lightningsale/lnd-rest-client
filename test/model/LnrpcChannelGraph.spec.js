...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new lnd.LnrpcChannelGraph();
  });
  ...
  describe('LnrpcChannelGraph', function() {
    it('should create an instance of LnrpcChannelGraph', function() {
      // uncomment below and update the code to test LnrpcChannelGraph
      //var instance = new lnd.LnrpcChannelGraph();
      //expect(instance).to.be.a(lnd.LnrpcChannelGraph);
    });
