...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new lnd.LnrpcSendManyRequest();
  });
  ...
  describe('LnrpcSendManyRequest', function() {
    it('should create an instance of LnrpcSendManyRequest', function() {
      // uncomment below and update the code to test LnrpcSendManyRequest
      //var instance = new lnd.LnrpcSendManyRequest();
      //expect(instance).to.be.a(lnd.LnrpcSendManyRequest);
    });

    it('should have the property addrToAmount (base name: "AddrToAmount")', function() {
      // uncomment below and update the code to test the property addrToAmount
      //var instance = new lnd.LnrpcSendManyRequest();
