    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('upfront_shutdown')) {
                obj['upfront_shutdown'] = ApiClient.convertToType(data['upfront_shutdown'], 'String');
            }
            ...
            if (data.hasOwnProperty('reserve_sat')) {
                obj['reserve_sat'] = ApiClient.convertToType(data['reserve_sat'], 'String');
            }
            if (data.hasOwnProperty('in_flight_max_msat')) {
                obj['in_flight_max_msat'] = ApiClient.convertToType(data['in_flight_max_msat'], 'String');
            }
            if (data.hasOwnProperty('max_htlc_count')) {
                obj['max_htlc_count'] = ApiClient.convertToType(data['max_htlc_count'], 'Number');
            }
            if (data.hasOwnProperty('min_htlc_in')) {
                obj['min_htlc_in'] = ApiClient.convertToType(data['min_htlc_in'], 'String');
            }
            if (data.hasOwnProperty('min_accept_depth')) {
                obj['min_accept_depth'] = ApiClient.convertToType(data['min_accept_depth'], 'Number');
            }
        }
        return obj;
    }
...
export default LnrpcChannelAcceptResponse;
