    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('chan_point')) {
                obj['chan_point'] = ApiClient.convertToType(data['chan_point'], 'String');
            }
            ...
            if (data.hasOwnProperty('node1_pub')) {
                obj['node1_pub'] = ApiClient.convertToType(data['node1_pub'], 'String');
            }
            if (data.hasOwnProperty('node2_pub')) {
                obj['node2_pub'] = ApiClient.convertToType(data['node2_pub'], 'String');
            }
            if (data.hasOwnProperty('capacity')) {
                obj['capacity'] = ApiClient.convertToType(data['capacity'], 'String');
            }
            if (data.hasOwnProperty('node1_policy')) {
                obj['node1_policy'] = LnrpcRoutingPolicy.constructFromObject(data['node1_policy']);
            }
            if (data.hasOwnProperty('node2_policy')) {
                obj['node2_policy'] = LnrpcRoutingPolicy.constructFromObject(data['node2_policy']);
            }
        }
        return obj;
    }
...
export default LnrpcChannelEdge;
